/*! For license information please see b2ff0c79.js.LICENSE.txt */
;(self.webpackChunk_articulate_mondrian_bundles =
  ...
  [356],
  {
    ...
    5494: (t, e, n) => {
      ...
      function F(t) {
        const e = j(t)
        return P(e) ? (t.ownerDocument ? t.ownerDocument.body : t.body) : E(e) && N(e) ? e : F(e)
      }
      function B(t, e, n) {
        var r
      ...
      function Y(t, e) {
        const n = j(t)
        return !(n === e || !T(n) || P(n)) && ('fixed' === I(n).position || Y(n, e))
      }
      function X(t, e, n) {
        const r = E(e),
          o = O(e),
          ...
          return (
            void 0 === t && (t = {}),
            {
              ...
              async fn(e) {
                ...
                if (((D = [...D, { placement: o, overflows: R }]), !R.every((t) => t <= 0))) {
                  var P, I
                  const t = ((null == (P = i.flip) ? void 0 : P.index) || 0) + 1,
                    e = z[t]
                  if (e) return { data: { index: t, overflows: D }, reset: { placement: e } }
                  let n =
                    null ==
                    (I = D.filter((t) => t.overflows[0] <= 0).sort(
    ...
    4198: (t, e, n) => {
            ...
            o.map((n) => {
              const o = r.filter((t) => t.type === n.name),
                ...
                s = K({
                  ...
                  content: H(P(n, 'content', i)),
                  marks: H(P(n, 'marks', i)),
                  group: H(P(n, 'group', i)),
                  inline: H(P(n, 'inline', i)),
                  atom: H(P(n, 'atom', i)),
                  selectable: H(P(n, 'selectable', i)),
                  draggable: H(P(n, 'draggable', i)),
                  code: H(P(n, 'code', i)),
                  defining: H(P(n, 'defining', i)),
                  isolating: H(P(n, 'isolating', i)),
            ...
            s.map((n) => {
              const o = r.filter((t) => t.type === n.name),
                ...
                s = K({
                  ...
                  inclusive: H(P(n, 'inclusive', i)),
                  excludes: H(P(n, 'excludes', i)),
                  group: H(P(n, 'group', i)),
                  spanning: H(P(n, 'spanning', i)),
                  code: H(P(n, 'code', i)),
                  attrs: Object.fromEntries(
                    o.map((t) => {
                      var e
        ...
        return (
          s.forEach((t) => {
            ...
            const s = l.state.tr,
              ...
              { commands: p, chain: f, can: m } = new D({ editor: n, state: c })
          ...
          const s = t.tr,
            ...
            d = (function (t) {
              const {
                ...
                { commands: l, chain: c, can: d } = new D({ editor: e, state: n }),
                u = []
              return (
      ...
      class nt {
        ...
        setupExtensions() {
          this.extensions.forEach((t) => {
            ...
            'mark' === t.type &&
              (null === (e = H(P(t, 'keepOnSplit', n))) || void 0 === e || e) &&
      ...
      class it {
        constructor(t = {}) {
          ;((this.type = 'extension'),
            ...
            this.config.addOptions &&
              (this.options = H(P(this, 'addOptions', { name: this.name }))),
            (this.storage =
              H(P(this, 'addStorage', { name: this.name, options: this.options })) || {}))
        }
        static create(t = {}) {
          return new it(t)
        }
        configure(t = {}) {
          ...
          return (
            ...
            (e.storage = H(P(e, 'addStorage', { name: e.name, options: e.options }))),
            e
          )
        }
        extend(t = {}) {
          ...
          return (
            ...
            (e.options = H(P(e, 'addOptions', { name: e.name }))),
            (e.storage = H(P(e, 'addStorage', { name: e.name, options: e.options }))),
            e
          )
        }
      ...
      function _t(t, e) {
        const { nodeExtensions: n } = I(e),
          r = n.find((e) => e.name === t)
        if (!r) return !1
        const o = H(P(r, 'group', { name: r.name, options: r.options, storage: r.storage }))
              ...
              new r.k_({
                ...
                appendTransaction: (t, e, n) => {
                  ...
                  const c = n.tr,
                    ...
                    { commands: u } = new D({ editor: this.editor, state: d })
          ...
          Xt.initialized ||
            (function () {
              Xt.scanner = (function (t = []) {
                ...
                for (let t = 0; t < Dt.length; t++) Lt(n, Dt[t], T, S, Jt)
                for (let t = 0; t < Pt.length; t++) Lt(n, Pt[t], E, M, Wt)
                ;(y(T, { tld: !0, ascii: !0 }, e),
              ...
              Xt.parser = (function ({ groups: t }) {
                const e = t.domain.concat([
                  ...
                  r = [Y, X, Q, et, nt, rt, st, lt, dt, D, P, ut, ht, pt, ft, mt, bt, St, wt, xt],
                  o = Zt(),
                  i = k(o, wt)
    ...
    196: (t, e, n) => {
          ...
          for (let e = 1; e <= 2; e++)
            for (let n = 1 == e ? t : this.unplaced.openStart; n >= 0; n--) {
              let t,
                o = null
              n
                ? ((o = D(this.unplaced.content, n - 1).firstChild), (t = o.content))
          ...
          for (; c < a.childCount; ) {
            ...
            ;(c++,
              (c > 1 || 0 == l || t.content.size) &&
                ((u = e),
                d.push(
                  P(t.mark(h.allowedMarks(t.marks)), 1 == c ? l : 0, c == a.childCount ? p : -1),
                )))
          }
      ...
      function P(t, e, n) {
        ...
        let o = t.content
        return (
          e > 1 && (o = o.replaceChild(0, P(o.firstChild, e - 1, 1 == o.childCount ? n - 1 : 0))),
          e > 0 &&
    ...
    5873: (t, e, n) => {
      ...
      const O = !S && /Chrome\/(\d+)/.exec(b),
        ...
        D = R ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0
      function P(t) {
      ...
      function Ot(t) {
        return t.editable
          ? t.hasFocus()
          : Pt(t) && document.activeElement && document.activeElement.contains(t.dom)
      }
      function At(t, e = !1) {
      ...
      function Dt(t) {
        return !(t.editable && !t.hasFocus()) && Pt(t)
      }
      function Pt(t) {
        let e = t.domSelectionRange()
      ...
      class $e {
        ...
        map(t, e, n, r) {
          ...
          return i ? null : new Pe(o - n, o - n, this)
        }
        valid() {
          return !0
        }
      ...
      class Re {
        ...
        map(t, e, n, r) {
          ...
          return o >= i ? null : new Pe(o, i, this)
        }
        valid(t, e) {
          return e.from < e.to
        }
      ...
      class De {
        ...
        map(t, e, n, r) {
          ...
          return i.deleted || i.pos <= o.pos ? null : new Pe(o.pos - n, i.pos - n, this)
        }
        valid(t, e) {
          let n,
        ...
        eq(t) {
          return this == t || (t instanceof De && ze(this.attrs, t.attrs) && ze(this.spec, t.spec))
        }
        destroy() {}
      }
      class Pe {
        ...
        static widget(t, e, n) {
          return new Pe(t, t, new $e(e, n))
        }
        static inline(t, e, n, r) {
          return new Pe(t, e, new Re(n, r))
        }
        static node(t, e, n, r) {
          return new Pe(t, e, new De(n, r))
        }
        get spec() {
      ...
      function He(t, e) {
        ...
        for (let r = 0; r < t.length; r++) {
          let o = t[r]
          n.push(new Pe(o.from + e, o.to + e, o.type))
        }
        return n
      }
      function Ve(t, e, n) {
      ...
      function un(t) {
        ...
        return (
          ...
          [Pe.node(0, t.state.doc.content.size, e)]
        )
      }
      function hn(t) {
        if (t.markCursor) {
          ...
          ;((e.className = 'ProseMirror-separator'),
            ...
            (t.cursorWrapper = {
              dom: e,
              deco: Pe.widget(t.state.selection.head, e, { raw: !0, marks: t.markCursor }),
            }))
    ...
    8182: (t, e, n) => {
      ...
      const D = r.xIx('ZodMiniOptional', (t, e) => {
        ;(r.igI.init(t, e), o.init(t, e))
      })
      function P(t) {
        return new D({ type: 'optional', innerType: t })
      }
      const I = r.xIx('ZodMiniNullable', (t, e) => {
        ;(r.ZQr.init(t, e), o.init(t, e))
      })
      function L(t) {
        return new I({ type: 'nullable', innerType: t })
      }
      const j = r.xIx('ZodMiniLazy', (t, e) => {
        ;(r.kU.init(t, e), o.init(t, e))
      })
      function F(t) {
        return new j({ type: 'lazy', getter: t })
      }
      ;(r.q0y, r.mIj, n(1341))
    },
    6492: (t, e, n) => {
      ...
      const l = (t, e) => {
          ;((t.name = '$ZodError'),
            ...
            (t.message = JSON.stringify(e, a.jsonStringifyReplacer, 2)),
            Object.defineProperty(t, 'toString', { value: () => t.message, enumerable: !1 }))
        },
        c = r('$ZodError', l),
        d = r('$ZodError', l, { Parent: Error }),
        u = ((t) => (e, n, r, i) => {
          const l = r ? Object.assign(r, { async: !1 }) : { async: !1 },
            c = e._zod.run({ value: n, issues: [] }, l)
          if (c instanceof Promise) throw new o()
          if (c.issues.length) {
            const e = new (i?.Err ?? t)(c.issues.map((t) => a.finalizeIssue(t, l, s())))
            throw (a.captureStackTrace(e, i?.callee), e)
          }
          return c.value
        })(d),
        h = ((t) => async (e, n, r, o) => {
          const i = r ? Object.assign(r, { async: !0 }) : { async: !0 }
          let l = e._zod.run({ value: n, issues: [] }, i)
          if ((l instanceof Promise && (l = await l), l.issues.length)) {
            const e = new (o?.Err ?? t)(l.issues.map((t) => a.finalizeIssue(t, i, s())))
            throw (a.captureStackTrace(e, o?.callee), e)
          }
          return l.value
        })(d),
        p = ((t) => (e, n, r) => {
          const i = r ? { ...r, async: !1 } : { async: !1 },
            l = e._zod.run({ value: n, issues: [] }, i)
          if (l instanceof Promise) throw new o()
          return l.issues.length
            ? { success: !1, error: new (t ?? c)(l.issues.map((t) => a.finalizeIssue(t, i, s()))) }
        ...
        f = ((t) => async (e, n, r) => {
          ...
          return (
            ...
            i.issues.length
              ? { success: !1, error: new t(i.issues.map((t) => a.finalizeIssue(t, o, s()))) }
        ...
        v = { number: 'number', bigint: 'bigint', object: 'date' },
        b = r('$ZodCheckLessThan', (t, e) => {
          y.init(t, e)
          const n = v[typeof e.value]
        ...
        x = r('$ZodCheckMaxLength', (t, e) => {
          var n
          ;(y.init(t, e),
            (n = t._zod.def).when ??
              (n.when = (t) => {
                const e = t.value
                return !a.nullish(e) && void 0 !== e.length
              }),
            t._zod.onattach.push((t) => {
            ...
            (t._zod.check = (n) => {
              ...
              const o = a.getLengthableOrigin(r)
              n.issues.push({
                origin: o,
                code: 'too_big',
                maximum: e.maximum,
        ...
        S = { major: 4, minor: 1, patch: 13 },
        M = r('$ZodType', (t, e) => {
          var n
          ;(t ?? (t = {}), (t._zod.def = e), (t._zod.bag = t._zod.bag || {}), (t._zod.version = S))
            ...
            const e = (t, e, n) => {
                ...
                for (const s of e) {
                  ...
                  const e = t.issues.length,
                    l = s._zod.check(t)
                  if (l instanceof Promise && !1 === n?.async) throw new o()
                  if (r || l instanceof Promise)
                    r = (r ?? Promise.resolve()).then(async () => {
                      ;(await l, t.issues.length !== e && (i || (i = a.aborted(t, e))))
                    })
                  else {
              ...
              n = (n, i, s) => {
                if (a.aborted(n)) return ((n.aborted = !0), n)
                const l = e(i, r, s)
                if (l instanceof Promise) {
                  if (!1 === s.async) throw new o()
                  return l.then((e) => t._zod.parse(e, s))
                }
                return t._zod.parse(l, s)
              }
            t._zod.run = (i, s) => {
        ...
        O = r('$ZodNumber', (t, e) => {
          ;(M.init(t, e),
            (t._zod.pattern = t._zod.bag.pattern ?? m),
            (t._zod.parse = (n, r) => {
              if (e.coerce)
                try {
      ...
      function _(t, e, n) {
        ;(t.issues.length && e.issues.push(...a.prefixIssues(n, t.issues)), (e.value[n] = t.value))
      }
      const N = r('$ZodArray', (t, e) => {
        ;(M.init(t, e),
          (t._zod.parse = (n, r) => {
            const o = n.value
            if (!Array.isArray(o))
            ...
            for (let t = 0; t < o.length; t++) {
              ...
              a instanceof Promise ? i.push(a.then((e) => _(e, n, t))) : _(a, n, t)
            }
            return i.length ? Promise.all(i).then(() => n) : n
          }))
      })
      function z(t, e, n, r) {
        ;(t.issues.length && e.issues.push(...a.prefixIssues(n, t.issues)),
          void 0 === t.value ? n in r && (e.value[n] = void 0) : (e.value[n] = t.value))
      }
      const $ = r('$ZodObject', (t, e) => {
        M.init(t, e)
        ...
        const r = a.cached(() =>
          (function (t) {
            ...
            const n = a.optionalKeys(t.shape)
            return {
              ...t,
              keys: e,
              keySet: new Set(e),
        ...
        a.defineLazy(t._zod, 'propValues', () => {
          const t = e.shape,
            n = {}
          for (const e in t) {
            const r = t[e]._zod
        ...
        t._zod.parse = (e, n) => {
          ...
          for (const t of s.keys) {
            ...
            r instanceof Promise ? l.push(r.then((n) => z(n, e, t, a))) : z(r, e, t, a)
          }
          return i
            ? (function (t, e, n, r, o, i) {
                ...
                for (const o in e) {
                  ...
                  i instanceof Promise ? t.push(i.then((t) => z(t, n, o, e))) : z(i, n, o, e)
                }
                return (
                  s.length &&
      ...
      function R(t, e, n, r) {
        ...
        const o = t.filter((t) => !a.aborted(t))
        return 1 === o.length
      ...
      const D = r('$ZodUnion', (t, e) => {
          ...
          t._zod.parse = (o, i) => {
            ...
            return s ? Promise.all(a).then((e) => R(e, o, t, i)) : R(a, o, t, i)
          }
        }),
        P = r('$ZodDiscriminatedUnion', (t, e) => {
          D.init(t, e)
          ...
          t._zod.parse = (o, i) => {
            ...
            const l = r.value.get(s?.[e.discriminator])
            return l
              ? l._zod.run(o, i)
              : e.unionFallback
                ? n(o, i)
          ...
          ;(M.init(t, e),
            (t._zod.parse = (t, n) => {
              ...
              return o instanceof Promise || i instanceof Promise
                ? Promise.all([o, i]).then(([e, n]) => j(t, e, n))
                : j(t, o, i)
            }))
        })
      function L(t, e) {
        ...
        if (a.isPlainObject(t) && a.isPlainObject(e)) {
      ...
      const F = r('$ZodTuple', (t, e) => {
        ...
        t._zod.parse = (r, o) => {
          ...
          for (const t of n) {
            ...
            e instanceof Promise ? s.push(e.then((t) => B(t, r, c))) : B(e, r, c)
          }
          if (e.rest) {
            ...
            for (const n of t) {
              ...
              t instanceof Promise ? s.push(t.then((t) => B(t, r, c))) : B(t, r, c)
            }
          }
      ...
      const H = r('$ZodRecord', (t, e) => {
          ;(M.init(t, e),
            (t._zod.parse = (n, r) => {
              ...
              const i = [],
                l = e.keyType._zod.values
              if (l) {
                n.value = {}
                const s = new Set()
                for (const t of l)
                  if ('string' == typeof t || 'number' == typeof t || 'symbol' == typeof t) {
                    s.add('number' == typeof t ? t.toString() : t)
                    const l = e.valueType._zod.run({ value: o[t], issues: [] }, r)
                    l instanceof Promise
                      ? i.push(
                          l.then((e) => {
                            ;(e.issues.length && n.issues.push(...a.prefixIssues(t, e.issues)),
                              (n.value[t] = e.value))
                          }),
                        )
                      : (l.issues.length && n.issues.push(...a.prefixIssues(t, l.issues)),
                        (n.value[t] = l.value))
                  }
                let c
                for (const t in o) s.has(t) || ((c = c ?? []), c.push(t))
                c &&
                  c.length > 0 &&
                  n.issues.push({ code: 'unrecognized_keys', input: o, inst: t, keys: c })
              } else {
                n.value = {}
                for (const l of Reflect.ownKeys(o)) {
                  if ('__proto__' === l) continue
                  const c = e.keyType._zod.run({ value: l, issues: [] }, r)
                  ...
                  if (c.issues.length) {
                    ;(n.issues.push({
                      code: 'invalid_key',
                      origin: 'record',
                      issues: c.issues.map((t) => a.finalizeIssue(t, r, s())),
                      input: l,
                      path: [l],
                      inst: t,
                    }),
                  ...
                  const d = e.valueType._zod.run({ value: o[l], issues: [] }, r)
                  d instanceof Promise
                    ? i.push(
                        d.then((t) => {
                          ;(t.issues.length && n.issues.push(...a.prefixIssues(l, t.issues)),
                            (n.value[c.value] = t.value))
                        }),
                      )
                    : (d.issues.length && n.issues.push(...a.prefixIssues(l, d.issues)),
        ...
        V = r('$ZodEnum', (t, e) => {
          M.init(t, e)
          const n = a.getEnumValues(e.entries),
            r = new Set(n)
          ;((t._zod.values = r),
            (t._zod.pattern = new RegExp(
              `^(${n
                .filter((t) => a.propertyKeyTypes.has(typeof t))
                .map((t) => ('string' == typeof t ? a.escapeRegex(t) : t.toString()))
                .join('|')})$`,
            )),
            (t._zod.parse = (e, o) => {
              const i = e.value
        ...
        K = r('$ZodLiteral', (t, e) => {
          if ((M.init(t, e), 0 === e.values.length))
            throw new Error('Cannot create literal schema with no valid values')
          const n = new Set(e.values)
          ;((t._zod.values = n),
            (t._zod.pattern = new RegExp(
              `^(${e.values.map((t) => ('string' == typeof t ? a.escapeRegex(t) : t ? a.escapeRegex(t.toString()) : String(t))).join('|')})$`,
            )),
            (t._zod.parse = (r, o) => {
              const i = r.value
              return (
      ...
      const J = r('$ZodOptional', (t, e) => {
          ;(M.init(t, e),
            ...
            a.defineLazy(t._zod, 'pattern', () => {
              ...
              return t ? new RegExp(`^(${a.cleanRegex(t.source)})?$`) : void 0
            }),
            (t._zod.parse = (t, n) => {
              if ('optional' === e.innerType._zod.optin) {
                const r = e.innerType._zod.run(t, n)
                return r instanceof Promise ? r.then((e) => U(e, t.value)) : U(r, t.value)
              }
        ...
        W = r('$ZodNullable', (t, e) => {
          ;(M.init(t, e),
            a.defineLazy(t._zod, 'optin', () => e.innerType._zod.optin),
            a.defineLazy(t._zod, 'optout', () => e.innerType._zod.optout),
            a.defineLazy(t._zod, 'pattern', () => {
              const t = e.innerType._zod.pattern
              return t ? new RegExp(`^(${a.cleanRegex(t.source)}|null)$`) : void 0
            }),
            a.defineLazy(t._zod, 'values', () =>
        ...
        q = r('$ZodLazy', (t, e) => {
          ;(M.init(t, e),
            a.defineLazy(t._zod, 'innerType', () => e.getter()),
            a.defineLazy(t._zod, 'pattern', () => t._zod.innerType?._zod?.pattern),
            a.defineLazy(t._zod, 'propValues', () => t._zod.innerType?._zod?.propValues),
            a.defineLazy(t._zod, 'optin', () => t._zod.innerType?._zod?.optin ?? void 0),
            a.defineLazy(t._zod, 'optout', () => t._zod.innerType?._zod?.optout ?? void 0),
            (t._zod.parse = (e, n) => t._zod.innerType._zod.run(e, n)))
        })
      var Z
      ;(n(1341), Symbol('ZodOutput'), Symbol('ZodInput'))
      ;(Z = globalThis).__zod_globalRegistry ??
        (Z.__zod_globalRegistry = new (class {
          constructor() {
      ...
      function Y(t, e) {
        return new t({ type: 'string', ...a.normalizeParams(e) })
      }
      function X(t, e) {
        return new t({ type: 'number', checks: [], ...a.normalizeParams(e) })
      }
      function Q(t, e) {
        return new t({ type: 'boolean', ...a.normalizeParams(e) })
      }
      function tt(t) {
        return new t({ type: 'any' })
      }
      function et(t, e) {
        return new t({ type: 'never', ...a.normalizeParams(e) })
      }
      function nt(t, e) {
        return new b({ check: 'less_than', ...a.normalizeParams(e), value: t, inclusive: !0 })
      }
      function rt(t, e) {
        return new w({ check: 'greater_than', ...a.normalizeParams(e), value: t, inclusive: !0 })
      }
      function ot(t, e) {
        return new x({ check: 'max_length', ...a.normalizeParams(e), maximum: t })
      }
      function it(t, e) {
        return new k({ check: 'min_length', ...a.normalizeParams(e), minimum: t })
      }
      function st(t) {
        const e = new y({ check: 'describe' })
        return (
          (e._zod.onattach = [
            (e) => {
              const n = G.get(e) ?? {}
              G.add(e, { ...n, description: t })
            },
          ]),
          (e._zod.check = () => {}),
          e
