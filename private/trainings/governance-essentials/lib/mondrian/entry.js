...
;(() => {
  ...
  function P(e) {
    ...
    return (E[e](t, t.exports, P), (t.loaded = !0), t.exports)
  }
  ;((P.m = E),
    (P.c = O),
    (P.n = (e) => {
    ...
    (P.d = (e, r) => {
      for (var t in r)
        P.o(r, t) && !P.o(e, t) && Object.defineProperty(e, t, { enumerable: !0, get: r[t] })
    }),
    (P.f = {}),
    ...
    (P.l = (t, n, o, a) => {
      if (e[t]) e[t].push(n)
        ...
        var f = (r, n) => {
          ...
          c = setTimeout(f.bind(null, void 0, { type: 'timeout', target: i }), 12e4)
    ...
    (() => {
      ...
      P.I = (t, n) => {
        ...
        if ((o || (o = r[t] = {}), !(n.indexOf(o) >= 0))) {
          ...
          return (
            'default' === t &&
              (u('svelte/store', '^5.0.0', () =>
                Promise.all([P.e(743), P.e(142)]).then(() => () => P(2142)),
              ),
              u('svelte', '^5.0.0', () => P.e(743).then(() => () => P(6366)))),
    ...
    (o = (e) => {
      ...
      if (r + 0.5) {
        ...
        for (var n = 1, a = 1; a < e.length; a++)
          (n--, (t += 'u' == (typeof (u = e[a]))[0] ? '-' : (n > 0 ? '.' : '') + ((n = 2), u)))
        return t
      }
      var i = []
    ...
    (l = (e) => Object.keys(e).reduce((r, t) => (e[t].eager && (r[t] = e[t]), r), {})),
    (s = (e, r, t, o) => {
      var i = o ? l(e[r]) : e[r]
      return (r = Object.keys(i).reduce((e, r) => (!a(t, r) || (e && !n(e, r)) ? e : r), 0)) && i[r]
    }),
    (d = (e, r, t) => {
      var o = t ? l(e[r]) : e[r]
      return Object.keys(o).reduce((e, r) => (!e || (!o[e].loaded && n(e, r)) ? r : e), 0)
    }),
    (f = (e, r, t, n) =>
      'Unsatisfied version ' +
      t +
    ...
    (m = (e, r, t) =>
      t ? t() : ((e, r) => p('Shared module ' + r + " doesn't exist in shared scope " + e))(e, r)),
    (g = (v = (e) =>
      function (r, t, n, o, a) {
        var i = P.I(r)
        return i && i.then && !n
          ? i.then(e.bind(e, r, P.S[r], t, !1, o, a))
          : e(r, P.S[r], t, n, o, a)
      })((e, r, t, n, o, a) => {
      if (!i(r, t)) return m(e, t, a)
      var l = s(r, t, o, n)
      return l ? u(l) : a ? a() : void p(c(r, e, t, o, n))
    })),
    (b = v((e, r, t, n, o, l) => {
      if (!i(r, t)) return m(e, t, l)
      var s = d(r, t, n)
      return (a(o, s) || h(f(r, t, s, o)), u(r[t][s]))
    })),
    (y = v((e, r, t, n, o, l) => {
      if (!i(r, t)) return m(e, t, l)
      var s = d(r, t, n)
      return (a(o, s) || p(f(r, t, s, o)), u(r[t][s]))
    })),
    (w = {}),
    (S = {
      4982: () =>
        g('default', 'svelte/store', !1, [1, 5, 0, 0], () => P.e(761).then(() => () => P(2142))),
