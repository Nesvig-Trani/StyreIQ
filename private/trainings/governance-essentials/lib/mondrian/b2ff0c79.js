...
;(self.webpackChunk_articulate_mondrian_bundles =
  ...
  [356],
  {
    ...
    4198: (t, e, n) => {
      ...
      function I(t) {
        const e = [],
          { nodeExtensions: n, markExtensions: r } = P(t),
          o = [...n, ...r],
          i = {
            default: null,
            rendered: !0,
      ...
      function K(t, e) {
        var n
        const r = I(t),
          { nodeExtensions: o, markExtensions: s } = P(t),
            ...
            o.map((n) => {
              const o = r.filter((t) => t.type === n.name),
                ...
                s = V({
                  ...
                  content: B(D(n, 'content', i)),
                  marks: B(D(n, 'marks', i)),
                  group: B(D(n, 'group', i)),
                  inline: B(D(n, 'inline', i)),
                  atom: B(D(n, 'atom', i)),
                  selectable: B(D(n, 'selectable', i)),
                  draggable: B(D(n, 'draggable', i)),
                  code: B(D(n, 'code', i)),
                  defining: B(D(n, 'defining', i)),
                  isolating: B(D(n, 'isolating', i)),
            ...
            s.map((n) => {
              const o = r.filter((t) => t.type === n.name),
                ...
                s = V({
                  ...
                  inclusive: B(D(n, 'inclusive', i)),
                  excludes: B(D(n, 'excludes', i)),
                  group: B(D(n, 'group', i)),
                  spanning: B(D(n, 'spanning', i)),
                  code: B(D(n, 'code', i)),
                  attrs: Object.fromEntries(
                    o.map((t) => {
                      var e
      ...
      class Q {
            ...
            i = e
              .map((e) => {
                ...
                if (
                  ('mark' === e.type &&
                    e.config.exitable &&
                    (l.ArrowRight = () => Pt.handleExit({ editor: t, mark: e })),
                  a)
                ) {
        ...
        get nodeViews() {
          const { editor: t } = this,
            { nodeExtensions: e } = P(this.extensions)
          return Object.fromEntries(
            e
        ...
        setupExtensions() {
          this.extensions.forEach((t) => {
            ...
            'mark' === t.type &&
              (null === (e = B(D(t, 'keepOnSplit', n))) || void 0 === e || e) &&
      ...
      class nt {
        constructor(t = {}) {
          ;((this.type = 'extension'),
            ...
            this.config.addOptions &&
              (this.options = B(D(this, 'addOptions', { name: this.name }))),
            (this.storage =
              B(D(this, 'addStorage', { name: this.name, options: this.options })) || {}))
        }
        static create(t = {}) {
          return new nt(t)
        }
        configure(t = {}) {
          ...
          return (
            ...
            (e.storage = B(D(e, 'addStorage', { name: e.name, options: e.options }))),
            e
          )
        }
        extend(t = {}) {
          ...
          return (
            ...
            (e.options = B(D(e, 'addOptions', { name: e.name }))),
            (e.storage = B(D(e, 'addStorage', { name: e.name, options: e.options }))),
            e
          )
        }
      ...
      function At(t, e) {
        const { nodeExtensions: n } = P(e),
          r = n.find((e) => e.name === t)
        if (!r) return !1
        const o = B(D(r, 'group', { name: r.name, options: r.options, storage: r.storage }))
