  ...
  ],
  {
    57324: (yl, ut, Wa) => {
      ...
      class pa extends HTMLElement {
        ...
        _$Ev() {
          ;((this._$ES = new Promise((a) => (this.enableUpdating = a))),
            (this._$AL = new Map()),
            this._$E_(),
            this.requestUpdate(),
            this.constructor.l?.forEach((a) => a(this)))
        }
        addController(a) {
        ...
        connectedCallback() {
          ;((this.renderRoot ??= this.createRenderRoot()),
            ...
            this._$EO?.forEach((a) => a.hostConnected?.()))
        }
        enableUpdating(a) {}
        ...
        jn = (r) => {
          const a = {
            background: [
              'linear-gradient(',
              'to right top, ',
              'var(--arc-color-logo-ai-purple, var(--arc-color-ai-purple-200)), ',
              'var(--arc-color-logo-ai-blue, var(--arc-color-ai-blue-200))',
              ')',
            ].join(''),
            backgroundClip: 'text',
            color: 'transparent',
...
`,
      ...
      const gr = {
          ...
          bypassConfirmWhen: {
            didPressEscapeKey: !1,
            didClickBackdrop: !1,
            didClickGoBackButton: !1,
            didClickDismissButton: !1,
            didClickPrimaryButton: !1,
            didClickSecondaryButton: !1,
            didClickTertiaryButton: !1,
          },
          headerProps: { showDivider: !1 },
