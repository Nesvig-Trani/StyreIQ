  ...
  [356],
  {
    ...
    7601: (t, e, n) => {
      ...
      const l = (t, ...e) => {
        ...
        k = (t, e) => !d(t, e),
        S = { attribute: !0, type: String, converter: x, reflect: !1, hasChanged: k }
      ...
      class M extends HTMLElement {
        ...
        static finalizeStyles(t) {
          ...
          if (Array.isArray(t)) {
            ...
            for (const t of n) e.unshift(c(t))
        ...
        _$EC(t, e) {
          ...
          if (void 0 !== r && !0 === n.reflect) {
            const o = (void 0 !== n.converter?.toAttribute ? n.converter : x).toAttribute(e, n.type)
            ;((this._$Em = t),
        ...
        requestUpdate(t, e, n) {
          if (void 0 !== t) {
            if (((n ??= this.constructor.getPropertyOptions(t)), !(n.hasChanged ?? k)(this[t], e)))
              return
            this.P(t, e, n)
          }
      ...
      ;((M.elementStyles = []),
        ...
        (M[w('elementProperties')] = new Map()),
        (M[w('finalized')] = new Map()),
        b?.({ ReactiveElement: M }),
    ...
    4198: (t, e, n) => {
      ...
      const c = (t, e, n) => {
        ...
        let c = a.nodeBefore
        if (!c.type.spec.isolating && S(t, a, e)) return !0
      ...
      function I(t) {
        const e = [],
          { nodeExtensions: n, markExtensions: r } = D(t),
          o = [...n, ...r],
          i = {
            default: null,
            rendered: !0,
        ...
        return (
          t.forEach((t) => {
            const n = P(t, 'addGlobalAttributes', {
              name: t.name,
              options: t.options,
              storage: t.storage,
            })
      ...
      function K(t, e) {
        var n
        const r = I(t),
          { nodeExtensions: o, markExtensions: s } = D(t),
          a = null === (n = o.find((t) => P(t, 'topNode'))) || void 0 === n ? void 0 : n.name,
          l = Object.fromEntries(
            o.map((n) => {
              const o = r.filter((t) => t.type === n.name),
                ...
                s = V({
                  ...t.reduce((t, e) => {
                    const r = P(e, 'extendNodeSchema', i)
                    return { ...t, ...(r ? r(n) : {}) }
                  }, {}),
                  content: B(P(n, 'content', i)),
                  marks: B(P(n, 'marks', i)),
                  group: B(P(n, 'group', i)),
                  inline: B(P(n, 'inline', i)),
                  atom: B(P(n, 'atom', i)),
                  selectable: B(P(n, 'selectable', i)),
                  draggable: B(P(n, 'draggable', i)),
                  code: B(P(n, 'code', i)),
                  defining: B(P(n, 'defining', i)),
                  isolating: B(P(n, 'isolating', i)),
                ...
                a = B(P(n, 'parseHTML', i))
              a && (s.parseDOM = a.map((t) => H(t, o)))
              const l = P(n, 'renderHTML', i)
              l && (s.toDOM = (t) => l({ node: t, HTMLAttributes: F(t, o) }))
              const c = P(n, 'renderText', i)
          ...
          c = Object.fromEntries(
            s.map((n) => {
              const o = r.filter((t) => t.type === n.name),
                ...
                s = V({
                  ...t.reduce((t, e) => {
                    const r = P(e, 'extendMarkSchema', i)
                    return { ...t, ...(r ? r(n) : {}) }
                  }, {}),
                  inclusive: B(P(n, 'inclusive', i)),
                  excludes: B(P(n, 'excludes', i)),
                  group: B(P(n, 'group', i)),
                  spanning: B(P(n, 'spanning', i)),
                  code: B(P(n, 'code', i)),
                  attrs: Object.fromEntries(
                    o.map((t) => {
                      var e
              ...
              a && (s.parseDOM = a.map((t) => H(t, o)))
              const l = P(n, 'renderHTML', i)
              return (l && (s.toDOM = (t) => l({ mark: t, HTMLAttributes: F(t, o) })), [n.name, s])
            }),
          )
      ...
      function Z(t) {
        ...
        return (
          s.forEach((t) => {
            ...
            if (!e) return
            const s = l.state.tr,
              c = $({ state: l.state, transaction: s }),
              h = { from: r - (e[0].length - i.length), to: o },
              { commands: p, chain: f, can: m } = new R({ editor: n, state: c })
          ...
          o = new r.k_({
                  ...
                  !!s &&
                    setTimeout(() => {
                      const { from: t, text: r } = s,
                        i = t + r.length
                      Z({ editor: e, from: t, to: i, text: r, rules: n, plugin: o })
                    }),
            ...
            props: {
              handleTextInput: (t, r, i, s) =>
                Z({ editor: e, from: r, to: i, text: s, rules: n, plugin: o }),
              handleDOMEvents: {
                compositionend: (t) => (
                  setTimeout(() => {
                    const { $cursor: r } = t.state.selection
                    r && Z({ editor: e, from: r.pos, to: r.pos, text: '', rules: n, plugin: o })
                  }),
                  !1
                ),
              },
              handleKeyDown(t, r) {
                ...
                return (
                  !!i && Z({ editor: e, from: i.pos, to: i.pos, text: '\n', rules: n, plugin: o })
                )
              },
            },
            isInputRules: !0,
          ...
          const s = t.tr,
            ...
            d = (function (t) {
              const {
                ...
                { commands: l, chain: c, can: d } = new R({ editor: e, state: n }),
                u = []
              return (
      ...
      class Q {
        constructor(t, e) {
          ;((this.splittableMarks = []),
            (this.editor = e),
            (this.extensions = Q.resolve(t)),
            (this.schema = K(this.extensions, e)),
            this.setupExtensions())
        }
        static resolve(t) {
          const e = Q.sort(Q.flatten(t)),
            n = (function (t) {
        ...
        get commands() {
          return this.extensions.reduce((t, e) => {
            const n = P(e, 'addCommands', {
              name: e.name,
              options: e.options,
              storage: e.storage,
              editor: this.editor,
              type: U(e.name, this.schema),
            })
            return n ? { ...t, ...n() } : t
          }, {})
        }
        get plugins() {
          const { editor: t } = this,
            e = Q.sort([...this.extensions].reverse()),
            n = [],
            r = [],
            i = e
              .map((e) => {
                const i = {
                  ...
                  s = [],
                  a = P(e, 'addKeyboardShortcuts', i)
                let l = {}
                if (
                  ('mark' === e.type &&
                    e.config.exitable &&
                    (l.ArrowRight = () => Dt.handleExit({ editor: t, mark: e })),
                  a)
                ) {
                ...
                const c = (0, o.w)(l)
                s.push(c)
                const d = P(e, 'addInputRules', i)
                J(e, t.options.enableInputRules) && d && n.push(...d())
                const u = P(e, 'addPasteRules', i)
                J(e, t.options.enablePasteRules) && u && r.push(...u())
                const h = P(e, 'addProseMirrorPlugins', i)
                if (h) {
                  const t = h()
                  s.push(...t)
                }
              ...
              .flat()
          return [G({ editor: t, rules: n }), ...X({ editor: t, rules: r }), ...i]
        }
        get attributes() {
          return I(this.extensions)
        }
        get nodeViews() {
          const { editor: t } = this,
            { nodeExtensions: e } = D(this.extensions)
          return Object.fromEntries(
            e
              .filter((t) => !!P(t, 'addNodeView'))
              .map((e) => {
        ...
        setupExtensions() {
          this.extensions.forEach((t) => {
            ...
            'mark' === t.type &&
              (null === (e = B(P(t, 'keepOnSplit', n))) || void 0 === e || e) &&
              this.splittableMarks.push(t.name)
            const r = P(t, 'onBeforeCreate', n),
              o = P(t, 'onCreate', n),
              i = P(t, 'onUpdate', n),
              s = P(t, 'onSelectionUpdate', n),
              a = P(t, 'onTransaction', n),
              l = P(t, 'onFocus', n),
              c = P(t, 'onBlur', n),
              d = P(t, 'onDestroy', n)
      ...
      class nt {
        constructor(t = {}) {
          ;((this.type = 'extension'),
            ...
            this.config.addOptions &&
              (this.options = B(P(this, 'addOptions', { name: this.name }))),
            (this.storage =
              B(P(this, 'addStorage', { name: this.name, options: this.options })) || {}))
        }
        static create(t = {}) {
          return new nt(t)
        }
        configure(t = {}) {
          ...
          return (
            ...
            (e.options = et(this.options, t)),
            (e.storage = B(P(e, 'addStorage', { name: e.name, options: e.options }))),
            e
          )
        }
        extend(t = {}) {
          const e = new nt({ ...this.config, ...t })
          return (
            (e.parent = this),
            (this.child = e),
            ...
            (e.options = B(P(e, 'addOptions', { name: e.name }))),
            (e.storage = B(P(e, 'addStorage', { name: e.name, options: e.options }))),
            e
          )
        }
      }
      function rt(t, e, n = { strict: !0 }) {
        const r = Object.keys(e)
        return (
          !r.length ||
          r.every((r) => (n.strict ? e[r] === t[r] : W(e[r]) ? e[r].test(t[r]) : e[r] === t[r]))
        )
      }
      function ot(t, e, n = {}) {
        return t.find((t) => t.type === e && rt(t.attrs, n))
      }
      function it(t, e, n = {}) {
        return !!ot(t, e, n)
      }
      function st(t, e, n = {}) {
        ...
        if (
          ...
          return
        const o = ot([...r.node.marks], e, n)
        if (!o) return
        let i = r.index,
          s = t.start() + r.offset,
          a = i + 1,
          l = s + r.node.nodeSize
        for (ot([...r.node.marks], e, n); i > 0 && o.isInSet(t.parent.child(i - 1).marks); )
          ((i -= 1), (s -= t.parent.child(i).nodeSize))
        for (; a < t.parent.childCount && it([...t.parent.child(a).marks], e, n); )
      ...
      function pt(t, e, n) {
        ...
        if (r) {
          ...
          return n.slice
            ? r.parseSlice(ht(t), n.parseOptions).content
            : r.parse(ht(t), n.parseOptions)
        }
        return pt('', e, n)
      }
      function ft() {
      ...
      function mt(t, e, n = {}) {
        ...
        const l = o - r,
          c = a
            ...
            .filter((t) => rt(t.node.attrs, n, { strict: !1 }))
      ...
      function kt(t, e) {
        return K(Q.resolve(t), e)
      }
      function St(t, e) {
        const n = gt('string' == typeof e ? e : e.name, t.schema)
        return 'node' === n
          ? (function (t, e) {
              const n = L(e, t.schema),
        ...
        return (
          t === e
            ? n
                ...
                .marks()
                .forEach((e) => {
                  const o = st(n.resolve(t - 1), e.type)
                  o && r.push({ mark: e, ...o })
                })
      ...
      function At(t, e) {
        const { nodeExtensions: n } = D(e),
          r = n.find((e) => e.name === t)
        if (!r) return !1
        const o = B(P(r, 'group', { name: r.name, options: r.options, storage: r.storage }))
      ...
      const Et = (t, e) => {
          const n = xt((t) => t.type === e)(t.selection)
          if (!n) return !0
      ...
      var Nt = Object.freeze({
        ...
        focus:
          ...
          ({ editor: n, view: o, tr: i, dispatch: s }) => {
            ...
            if (s && null === t && !lt(n.state.selection)) return (a(), !0)
            const l =
                (function (t, e = null) {
                  if (!e) return null
                  ...
                  const i = n.from,
                    s = o.to
                  return 'all' === e
                    ? r.U3.create(t, ct(0, i, s), ct(t.content.size, i, s))
                    : r.U3.create(t, ct(e, i, s), ct(e, i, s))
              ...
              ;(u
                ...
                n.updateSelection &&
                  (function (t, e) {
                    ...
                    if (n < e) return
                    const o = t.steps[n]
                    if (!(o instanceof s.Ln || o instanceof s.Wg)) return
                    const i = t.mapping.maps[n]
                    let a = 0
                    ;(i.forEach((t, e, n, r) => {
                      0 === a && (a = r)
                    }),
                      t.setSelection(r.LN.near(t.doc.resolve(a), -1)))
                  })(o, o.steps.length - 1),
        ...
        resetAttributes:
          ...
          ({ tr: n, state: r, dispatch: o }) => {
            let i = null,
              s = null
            const a = gt('string' == typeof t ? t : t.name, r.schema)
            return (
              !!a &&
              ('node' === a && (i = L(t, r.schema)),
              'mark' === a && (s = at(t, r.schema)),
              o &&
                n.selection.ranges.forEach((t) => {
                  r.doc.nodesBetween(t.$from.pos, t.$to.pos, (t, r) => {
                    ;(i && i === t.type && n.setNodeMarkup(r, void 0, yt(t.attrs, e)),
                      s &&
                        t.marks.length &&
                        t.marks.forEach((o) => {
                          s === o.type && n.addMark(r, r + t.nodeSize, s.create(yt(o.attrs, e)))
                        }))
                  })
                }),
              !0)
        ...
        setContent:
          ...
          ({ tr: r, editor: o, dispatch: i }) => {
            const { doc: s } = r,
              a = (function (t, e, n = {}) {
                return pt(t, e, { slice: !1, parseOptions: n })
              })(t, o.schema, n)
        ...
        setNode:
          ...
          ({ state: n, dispatch: r, chain: o }) => {
            const i = L(t, n.schema)
            return i.isTextblock
              ? o()
                  .command(({ commands: t }) => !!A(i, e)(n) || t.clearNodes())
                  .command(({ state: t }) => A(i, e)(t, r))
                  .run()
              : (console.warn(
        ...
        splitBlock:
          ...
          ({ tr: e, state: n, dispatch: o, editor: i }) => {
            const { selection: a, doc: l } = e,
              { $from: c, $to: d } = a,
              u = Ot(i.extensionManager.attributes, c.node().type.name, c.node().attrs)
            if (a instanceof r.nh && a.node.isBlock)
              return !(
                !c.parentOffset ||
                !(0, s.zy)(l, c.pos) ||
                (o &&
                  (t && Tt(n, i.extensionManager.splittableMarks), e.split(c.pos).scrollIntoView()),
                0)
              )
            ...
            if (o) {
              ...
              ;(t && Tt(n, i.extensionManager.splittableMarks), e.scrollIntoView())
            }
            return !0
          },
        splitListItem:
          ...
          ({ tr: e, state: n, dispatch: o, editor: a }) => {
                ...
                const o =
                    d.indexAfter(-1) < d.node(-2).childCount
                      ...
                      : d.indexAfter(-2) < d.node(-3).childCount
                        ? 2
                        : 3,
                  s = Ot(f, d.node().type.name, d.node().attrs),
                  a =
            ...
            const m = u.pos === d.end() ? p.contentMatchAt(0).defaultType : null,
              g = Ot(f, p.type.name, p.attrs),
              y = Ot(f, d.node().type.name, d.node().attrs)
        ...
        toggleList:
          ...
          ({ editor: o, tr: i, state: s, dispatch: a, chain: l, commands: c, can: d }) => {
            ...
            if (!b) return !1
            const x = xt((t) => At(t.type.name, u))(m)
            if (b.depth >= 1 && x && b.depth - x.depth <= 1) {
              if (x.node.type === p) return c.liftListItem(f)
              if (At(x.node.type.name, u) && p.validContent(x.node.content) && a)
                return l()
          ...
          ({ state: r, commands: o }) => {
            ...
            return (function (t, e, n = {}) {
              ...
              const l = a
                  ...
                  .filter((t) => rt(t.mark.attrs, n, { strict: !1 }))
        ...
        toggleNode:
          (t, e, n = {}) =>
          ({ state: r, commands: o }) => {
            const i = L(t, r.schema),
              s = L(e, r.schema)
            return mt(r, i, n) ? o.setNode(s) : o.setNode(i, n)
          },
        toggleWrap:
          (t, e = {}) =>
          ({ state: n, commands: r }) => {
            const o = L(t, n.schema)
            return mt(n, o, e) ? r.lift(o) : r.wrapIn(o, e)
          },
        undoInputRule:
          () =>
          ({ state: t, dispatch: e }) => {
      ...
      ;(nt.create({ name: 'commands', addCommands: () => ({ ...Nt }) }),
        nt.create({
          name: 'editable',
          addProseMirrorPlugins() {
            return [
            ...
            return [
              new r.k_({
                ...
                appendTransaction: (t, e, n) => {
                  ...
                  const c = n.tr,
                    d = $({ state: n, transaction: c }),
                    { commands: u } = new R({ editor: this.editor, state: d })
      ...
      function Lt(t) {
        return new Y({
          ...
          handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
            const i = B(t.getAttributes, void 0, r, o)
    ...
    1212: (t, e, n) => {
      ...
      ;((g.groups = {}),
        (g.prototype = {
          ...
          tr(t, e, n, r) {
            ...
            return (
              (r = r || g.groups),
              e && e.j ? (o = e) : ((o = new g(e)), n && r && m(e, n, r)),
              this.jr.push([t, o]),
              o
            )
          },
      ...
      const y = (t, e, n, r, o) => t.ta(e, n, r, o),
        v = (t, e, n, r, o) => t.tr(e, n, r, o),
        b = (t, e, n, r, o) => t.ts(e, n, r, o),
        w = (t, e, n, r, o) => t.tt(e, n, r, o),
        x = 'WORD',
        k = 'UWORD',
        S = 'ASCIINUMERICAL',
        M = 'ALPHANUMERICAL',
        ...
        j = 'OPENANGLEBRACKET',
        F = 'CLOSEANGLEBRACKET',
        B = 'FULLWIDTHLEFTPAREN',
        H = 'FULLWIDTHRIGHTPAREN',
        V = 'LEFTCORNERBRACKET',
      ...
      var kt = Object.freeze({
        ...
        FULLWIDTHLEFTPAREN: B,
        FULLWIDTHLESSTHAN: W,
        FULLWIDTHMIDDLEDOT: mt,
        FULLWIDTHRIGHTPAREN: H,
        HYPHEN: lt,
        LEFTCORNERBRACKET: V,
      ...
      function Nt(t, e, n, r, o) {
        ...
        for (let n = 0; n < s - 1; n++) {
          const s = e[n]
          ;(t.j[s] ? (i = t.j[s]) : ((i = new g(r)), (i.jr = o.slice()), (t.j[s] = i)), (t = i))
        }
        return ((i = new g(n)), (i.jr = o.slice()), (t.j[e[s - 1]] = i), i)
      }
      function zt(t) {
        const e = [],
          n = []
      ...
      function Rt(t, e = null) {
        ...
        t && (n = Object.assign(n, t instanceof Rt ? t.o : t))
      ...
      ;((Rt.prototype = {
        ...
        get(t, e, n) {
          ...
          return o
            ? ('object' == typeof o
                ? ((o = n.t in o ? o[n.t] : $t[t]), 'function' == typeof o && r && (o = o(e, n)))
      ...
      const Lt = It('email', {
        ...
        Bt = It('url', {
          isLink: !0,
          toHref(t = $t.defaultProtocol) {
            return this.hasProtocol() ? this.v : `${t}://${this.v}`
          },
          hasProtocol() {
            const t = this.tk
            return t.length >= 2 && t[0].t !== C && t[1].t === nt
          },
        }),
        Ht = (t) => new g(t)
      function Vt(t, e, n) {
      ...
      const Kt = ('undefined' != typeof console && console && console.warn) || (() => {}),
        Ut = {
          scanner: null,
          parser: null,
          tokenQueue: [],
      ...
      function Jt(t, e = !1) {
        ...
        Ut.customSchemes.push([t, e])
      }
      function Wt(t) {
        return (
          Ut.initialized ||
            (function () {
              Ut.scanner = (function (t = []) {
                const e = {}
                g.groups = e
                const n = new g()
                ;(null == Tt &&
                  ...
                  w(n, '\\', Q),
                  w(n, '・', mt))
                const r = v(n, Ot, _, { [o]: !0 })
                v(r, Ot, r)
                const f = v(r, St, S, { [a]: !0 }),
                  y = v(r, Mt, M, { [l]: !0 }),
                  _t = v(n, St, x, { [i]: !0 })
                ;(v(_t, Ot, f), v(_t, St, _t), v(f, Ot, f), v(f, St, f))
                const $t = v(n, Mt, k, { [s]: !0 })
                ;(v($t, St), v($t, Ot, y), v($t, Mt, $t), v(y, Ot, y), v(y, St), v(y, Mt, y))
                const Rt = w(n, '\n', z, { [p]: !0 }),
                  Pt = w(n, '\r', N, { [p]: !0 }),
                  Dt = v(n, At, N, { [p]: !0 })
                ;(w(n, '￼', Dt),
                  ...
                  v(Dt, At, Dt),
                  w(Dt, '￼', Dt))
                const It = v(n, Ct, wt, { [d]: !0 })
                ;(w(It, '#'), v(It, Ct, It), w(It, '️', It))
                const Lt = w(It, '‍')
                ;(w(Lt, '#'), v(Lt, Ct, It))
                const jt = [
                    [St, _t],
                ...
                for (let t = 0; t < Tt.length; t++) Nt(n, Tt[t], O, x, jt)
                for (let t = 0; t < Et.length; t++) Nt(n, Et[t], A, k, Ft)
                ;(m(O, { tld: !0, ascii: !0 }, e),
                  m(A, { utld: !0, alpha: !0 }, e),
                  Nt(n, 'file', T, x, jt),
                  Nt(n, 'mailto', T, x, jt),
                  Nt(n, 'http', E, x, jt),
                  Nt(n, 'https', E, x, jt),
                  Nt(n, 'ftp', E, x, jt),
                  Nt(n, 'ftps', E, x, jt),
                  m(T, { scheme: !0, ascii: !0 }, e),
                  m(E, { slashscheme: !0, ascii: !0 }, e),
                ...
                return (
                  b(n, 'localhost', C, { ascii: !0 }),
                  (n.jd = new g(xt)),
                  { start: n, tokens: Object.assign({ groups: e }, kt) }
                )
              })(Ut.customSchemes)
              for (let t = 0; t < Ut.tokenQueue.length; t++)
                Ut.tokenQueue[t][1]({ scanner: Ut.scanner })
              Ut.parser = (function ({ groups: t }) {
                const e = t.domain.concat([
                  ...
                  r = [Z, G, Y, Q, tt, et, ot, st, lt, $, R, ct, dt, ut, ht, pt, yt, xt, vt, bt],
                  o = Ht(),
                  i = w(o, vt)
                ;(y(i, r, i), y(i, t.domain, i))
                const s = Ht(),
                  a = Ht(),
                  l = Ht()
                ;(y(o, t.domain, s),
                  ...
                  y(s, t.domain, s))
                const c = w(s, X)
                ;(w(i, X, c), w(a, X, c), w(l, X, c))
                const d = w(i, it)
                ;(y(d, r, i), y(d, t.domain, i))
                const u = Ht()
                ;(y(c, t.domain, u), y(u, t.domain, u))
                const h = w(u, it)
                y(h, t.domain, u)
                const p = Ht(Lt)
                ;(y(h, t.tld, p), y(h, t.utld, p), w(c, C, p))
                const f = w(u, lt)
                ;(w(f, lt, f), y(f, t.domain, u), y(p, t.domain, u), w(p, it, h), w(p, lt, f))
                const m = w(p, nt)
                y(m, t.numeric, Lt)
                const g = w(s, lt),
                  v = w(s, it)
                ;(w(g, lt, g), y(g, t.domain, s), y(v, r, i), y(v, t.domain, s))
                const b = Ht(Bt)
                ;(y(v, t.tld, b),
                  y(v, t.utld, b),
                  y(b, t.domain, s),
                ...
                const S = Ht(Bt),
                  M = Ht()
                ;(y(S, e, S), y(S, n, M), y(M, e, S), y(M, n, M), w(b, yt, S), w(k, yt, S))
                const O = w(a, nt),
                  A = w(l, nt),
                  T = w(A, yt),
                  E = w(T, yt)
                ...
                for (let t = 0; t < N.length; t++) {
                  ...
                  y(i, e, s)
                  const a = Ht()
                  ;(y(i, n), y(s, e, s), y(s, n, a), y(a, e, s), y(a, n, a), w(s, o, S), w(a, o, S))
                }
                return (w(o, C, b), w(o, z, Ft), { start: o, tokens: kt })
              })(Ut.scanner.tokens)
              for (let t = 0; t < Ut.pluginQueue.length; t++)
                Ut.pluginQueue[t][1]({ scanner: Ut.scanner, parser: Ut.parser })
              Ut.initialized = !0
            })(),
          (function (t, e, n) {
            let r = n.length,
            ...
            for (; o < r; ) {
              ...
              if (h < 0) ((o -= d), o < r && (s.push(n[o]), o++))
                ...
                ;(s.length > 0 && (i.push(Vt(jt, e, s)), (s = [])), (o -= h), (d -= h))
                const t = u.t,
                  r = n.slice(o - d, o)
                i.push(Vt(t, e, r))
              }
            }
            return (s.length > 0 && i.push(Vt(jt, e, s)), i)
          })(Ut.parser.start, t, _t(Ut.scanner.start, t))
        )
      }
      function qt(t, e = null, n = null) {
      ...
      Wt.scan = _t
      var Zt = n(2559)
      const Gt = r.CU.create({
        name: 'link',
        priority: 1e3,
        keepOnSplit: !1,
        onCreate() {
          this.options.protocols.forEach((t) => {
            'string' != typeof t ? Jt(t.scheme, t.optionalSlashes) : Jt(t)
          })
        },
        onDestroy() {
          ;((g.groups = {}),
          ...
          return [
            (0, r.Zc)({
              find: (t) => {
                const e = []
                if (t) {
                  const n = qt(t).filter((t) => t.isLink)
                  n.length &&
                    n.forEach((t) =>
                  ...
                  return new Zt.k_({
                    ...
                    props: {
                      handlePaste: (e, n, r) => {
                        ...
                        const l = qt(a).find((t) => t.isLink && t.value === a)
                        return !(
                          !a ||
                          !l ||
