...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'overdue_notice_sent';
  ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'escalated_to_unit_admin';
  ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'escalated_to_central_admin';`)
}
