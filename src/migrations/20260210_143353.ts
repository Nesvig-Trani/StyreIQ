...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'email_sent';
  ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'email_failed';
  ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'task_creation_failed';
  ALTER TYPE "public"."enum_audit_log_action" ADD VALUE 'critical_error';`)
}
