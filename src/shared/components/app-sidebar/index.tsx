  ...
  return (
    <Sidebar {...props}>
      ...
      <div className="flex flex-col gap-3 px-4 pb-2">
        <section aria-label="Signed-in account" className="p-3 bg-gray-50 rounded-lg w-full">
          <dl className="min-w-0 space-y-0">
            <dt className="sr-only">Role</dt>
            <dd className="text-xs font-medium text-gray-900 truncate m-0">
              {roleLabelMap[effectiveRole as UserRolesEnum]}
            </dd>
            <dt className="sr-only">Email</dt>
            <dd className="text-xs text-gray-500 truncate m-0">{user.email}</dd>
          </dl>
        </section>
      ...
      <SidebarContent>
        <nav aria-label="Dashboard primary">
          <SidebarGroup>
            <SidebarMenu>
